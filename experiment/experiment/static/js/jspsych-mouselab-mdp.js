...
jsPsych.plugins['mouselab-mdp'] = (function() {
  ...
  MouselabMDP = class MouselabMDP {
    ...
    async showFeedback(action) {
      var a, delay, i, j, len, len1, loss, msg, oldLowerMessage, optimal, q, qs, ref, ref1, s, strictness, v;
      ...
      oldLowerMessage = this.lowerMessage.html();
      ...
      // Reset.
      this.lowerMessage.html(oldLowerMessage);
      this.freeze = false;

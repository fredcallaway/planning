...
jsPsych.plugins['mouselab-mdp'] = (function() {
  ...
  MouselabMDP = (function() {
    function MouselabMDP(config) {
      ...
      var blockName, centerMessage, leftMessage, lowerMessage, prompt, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref2, ref20, ref21, ref22, ref23, ref24, ref25, ref26, ref27, ref28, ref29, ref3, ref30, ref4, ref5, ref6, ref7, ref8, ref9, rightMessage, size, trial_id;
      this.display = config.display, this.graph = config.graph, this.layout = config.layout, this.initial = config.initial, this.stateLabels = (ref = config.stateLabels) != null ? ref : 'reward', this.stateDisplay = (ref1 = config.stateDisplay) != null ? ref1 : 'never', this.stateClickCost = (ref2 = config.stateClickCost) != null ? ref2 : 0, this.edgeLabels = (ref3 = config.edgeLabels) != null ? ref3 : 'never', this.edgeDisplay = (ref4 = config.edgeDisplay) != null ? ref4 : 'always', this.edgeClickCost = (ref5 = config.edgeClickCost) != null ? ref5 : 0, this.stateRewards = (ref6 = config.stateRewards) != null ? ref6 : null, this.clickDelay = (ref7 = config.clickDelay) != null ? ref7 : 0, this.moveDelay = (ref8 = config.moveDelay) != null ? ref8 : 500, this.clickEnergy = (ref9 = config.clickEnergy) != null ? ref9 : 0, this.moveEnergy = (ref10 = config.moveEnergy) != null ? ref10 : 0, this.startScore = (ref11 = config.startScore) != null ? ref11 : 0, this.demo = (ref12 = config.demo) != null ? ref12 : null, this.allowSimulation = (ref13 = config.allowSimulation) != null ? ref13 : false, this.revealRewards = (ref14 = config.revealRewards) != null ? ref14 : true, this.training = (ref15 = config.training) != null ? ref15 : false, this.special = (ref16 = config.special) != null ? ref16 : '', this.timeLimit = (ref17 = config.timeLimit) != null ? ref17 : null, this.minTime = (ref18 = config.minTime) != null ? ref18 : null, this.energyLimit = (ref19 = config.energyLimit) != null ? ref19 : null, this.keys = (ref20 = config.keys) != null ? ref20 : KEYS, this.trialIndex = (ref21 = config.trialIndex) != null ? ref21 : TRIAL_INDEX, this.playerImage = (ref22 = config.playerImage) != null ? ref22 : 'static/images/plane.png', size = (ref23 = config.size) != null ? ref23 : 80, trial_id = (ref24 = config.trial_id) != null ? ref24 : null, blockName = (ref25 = config.blockName) != null ? ref25 : 'none', prompt = (ref26 = config.prompt) != null ? ref26 : '&nbsp;', leftMessage = (ref27 = config.leftMessage) != null ? ref27 : '&nbsp;', centerMessage = (ref28 = config.centerMessage) != null ? ref28 : '&nbsp;', rightMessage = (ref29 = config.rightMessage) != null ? ref29 : RIGHT_MESSAGE, lowerMessage = (ref30 = config.lowerMessage) != null ? ref30 : '&nbsp;';
